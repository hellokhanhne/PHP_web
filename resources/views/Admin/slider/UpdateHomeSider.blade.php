           ...
           width: 100%;
                  ...
                  @method('PUT')
                          ...
                          <label for="file0" class="col-sm-6 item-image pb-3">
                              <p>Image</p>
                             <div>
                             <img src="{{ asset('/images/'.$item->image) }}" id="image" alt="" class="file-img">
                          ...
                          <label for="file1" class="col-sm-6 item-image pb-3">
                              <p>Imgae thumb</p>
                             <div>
                             <img src="{{ asset('/images/'.$item->image_thumb) }}" id="image_thumb" alt="" class="file-img">
      ...
      <script>
        ...
        $("input[type='file']").change( function (e) {
            ...
            const data_id = $(this).attr("data-id")
             upload(file,data_id,"idSlider","slider_home")
        })
