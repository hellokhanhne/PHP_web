            ...
            $("#update_form").submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(`.row_blog_${data.id} .td_image img`).attr('src', `{{asset('/images/')}}/${data.image}`)
                        resetInputFile()
                        $('#update_blog').modal('hide')
                 ...
                 $.ajax({
                    ...
                    success: function (rs) {
                        ...
                        for (let [index, item] of data.entries()) {
                            ...
                            <td>${index + 1}</td>
                            <td class="td_image"><img width="100" height="100" style="object-fit: cover" src="{{asset('/images/')}}/${item.image}" alt=""></td>
