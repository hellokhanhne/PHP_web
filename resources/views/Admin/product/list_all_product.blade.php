                        ...
                        @foreach ($products as $product)
                            <tr class="row_product_{{$product->id}}">
                                ...
                                <td class="td_image"><img width="100" height="100" style="object-fit: cover"
                                                        src="{{ asset('/images/'.$product->image0) }}" alt="">
                                </td>
                                <td>{{$product->rate}}</td>
            ...
            $("#imageArr").val(get_images_name_product);   
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(`.row_product_${data.id} .td_image img`).attr('src', `{{asset('/images/')}}/${data.image0}`)
                 ...
                 $.ajax({
                    ...
                    success: function (rs) {
                        ...
                        for (let [index, item] of data.entries()) {
                            ...
                            <td class="td_image"><img width="100" height="100" style="object-fit: cover" src="{{asset('/images/')}}/${item.image0}" alt=""></td>
                            <td>${item.rate}</td>
            ...
            function loadImageUpdaeModel(imagenames) {
                ...
                imagenames.forEach((img,index)=>{
                    ...
                    <label for="file${index}" class="col-sm-6 item-image pb-3">
                                <div>
                                <img src="{{asset('/images/${img}')}}" id="image${index}" alt="" class="file-img">
