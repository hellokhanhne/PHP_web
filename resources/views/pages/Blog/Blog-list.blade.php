                    ...
                    <div class="row vertical-gap">
                        ...
                        <div class="col-md-7 col-lg-6">
                            ...
                            <div class="nk-post-by">
                                <img src="<?php if($blog->admin) echo $blog->Admin->admin_avatar; else if(strpos(auth()->user()->avatar,"https://lh3") === false) echo asset('/images')."/".auth()->user()->avatar; else echo auth()->user()->avatar;   ?>"
