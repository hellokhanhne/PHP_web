                ...
                <div class="nk-post-text mt-0">
                    ...
                    <div class="nk-post-by">
                        ...
                        if($blog->admin===1) {
                            ...
                            if(strpos($blog->user->avatar,"https://lh3") === false) echo asset('/images')."/".$blog->user->avatar; else echo $blog->user->avatar;
                        }
                        ?>" 
...
<div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            <a href="blog-article.html" class="nk-post-img">
                                <img src="{{asset('/assets/images/post-3-mid')}}.jpg" alt="We found a witch! May we burn her?">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            <a href="blog-article.html" class="nk-post-img">
                                <img src="{{asset('/assets/images/post-4-mid')}}.jpg" alt="For good, too though, in consequence">
                ...
                <div class="nk-comments">
                    ...
                    <div class="nk-comment">
                        <div class="nk-comment-meta">
                            <img src="{{asset('/assets/images/avatar-2.jpg')}}" alt="Witch Murder" class="rounded-circle" width="35"> by <a href="#">Witch Murder</a> in 20 September, 2018
                        ...
                        <div class="nk-comment">
                            <div class="nk-comment-meta">
                                <img src="{{asset('/assets/images/avatar-1.jpg')}}" alt="Hitman" class="rounded-circle" width="35"> by <a href="#">Hitman</a> in 20 September, 2018
                                <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 float-right">Reply</a>
                            </div>
                            <div class="nk-comment-text">
                    ...
                    <div class="nk-comment">
                        <div class="nk-comment-meta">
                            <img src="{{asset('/assets/images/avatar-3.jpg')}}" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in 21 September, 2018
                            <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 float-right">Reply</a>
                        </div>
                        <div class="nk-comment-text">
