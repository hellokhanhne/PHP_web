                        ...
                        <div class="status-post">
                           ...
                           ?>
                            ...
                            <div class="nk-post-by">
                                <img style="object-fit: cover; border-radius:50%;width: 30px;height:30px;" src="<?php if(strpos(auth()->user()->avatar,"https://lh3") === false) echo asset('/images')."/".auth()->user()->avatar; else echo auth()->user()->avatar;  ?>" alt="Hitman" class="rounded-circle" width="30"> by <a href="#">{{$blog->User->name}}</a> {{$blog->created_at}}
                            </div>
                            <div class="nk-gap"></div>
            ...
            <script>
                ...
                $('#update_blog').on('show.bs.modal', function (event) {
                    ...
                    $.get(`{{ URL::to('/blog/getByID') }}/${get_id_blog}`,(data) => {
                        ...
                        $('#blog-avt-display').attr("src",`{{asset('/images/')}}/${data.image}`)             
                    })
                })
                 // confirm update blog
