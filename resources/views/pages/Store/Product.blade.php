                        ...
                        <div class="col-md-6">
                            ...
                            <div class="nk-popup-gallery">
                                <div class="nk-gallery-item-box">
                                    <a href="{{ asset('/images/'.$product->image0) }}" class="nk-gallery-item" data-size="1200x554">
                                ...
                                <div class="row vertical-gap sm-gap">
                                   ...
                                   <div class="col-6 col-md-4">
                                        <div class="nk-gallery-item-box">
                                            <a href="{{ asset('/images/'.$image) }}" class="nk-gallery-item" data-size="622x942">
                                                <div class="nk-gallery-item-overlay"><span class="ion-eye"></span></div>
                                ...
                                <div class="nk-product-info-row row vertical-gap">
                                    <div class="col-md-5">
                                        <div class="nk-product-pegi">
                                            <div class="nk-gap"></div>
                                            <img src="{{asset('/assets/images/pegi-icon.jpg')}}" alt="">
                  ...
                  <div class="col-md-6">
                      <div class="nk-product-cat">
                          <a class="nk-product-image" href="{{URL::to('/product/'.$item->id)}}">
                              <img src="{{asset('/images/')}}/{{$item->image0}}" alt="She gave my mother">
                          </a>
                        ...
                        <div class="nk-widget-content">
                            ...
                            <div class="nk-widget-post">
                                <a href="store-product.html" class="nk-post-image">
                                    <img src="{{asset('/assets/images/product-1-xs')}}.jpg" alt="So saying he unbuckled">
                                </a>
                            ...
                            <div class="nk-widget-post">
                                <a href="store-product.html" class="nk-post-image">
                                    <img src="{{asset('/assets/images/product-2-xs')}}.jpg" alt="However, I have reason">
                                </a>
                            ...
                            <div class="nk-widget-post">
                                <a href="store-product.html" class="nk-post-image">
                                    <img src="{{asset('/assets/images/product-3-xs')}}.jpg" alt="It was some time before">
                                </a>
