 ...
 <div class="nk-tabs">
     ...
     <div class="tab-content">
         <div role="tabpanel" class="tab-pane fade show active" id="tabs-1-1">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <a href="blog-article.html" class="nk-post-img">
                     <img src="{{ asset('/assets/images/'.$banner->image_banner) }}" alt="{{$banner->title}}">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <div class="row vertical-gap">
                     <div class="col-lg-3 col-md-5">
                         <a href="blog-article.html" class="nk-post-img">
                             <img src="{{ asset('/assets/images/'.$action->image) }}" alt="{{$action->title}}">
                             <span class="nk-post-categories">
         ...
         <div role="tabpanel" class="tab-pane fade" id="tabs-1-2">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <a href="blog-article.html" class="nk-post-img">
                     <img src="{{ asset('/assets/images/'.$mmo->image_banner) }}" alt="{{$mmo->title}}">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <div class="row vertical-gap">
                     <div class="col-lg-3 col-md-5">
                         <a href="blog-article.html" class="nk-post-img">
                             <img src="{{ asset('/assets/images/'.$mo->image) }}" alt="{{$mo->title}}">
                             <span class="nk-post-categories">
         ...
         <div role="tabpanel" class="tab-pane fade" id="tabs-1-3">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <a href="blog-article.html" class="nk-post-img">
                     <img src="{{ asset('/assets/images/'.$strategy->image_banner) }}" alt="{{$strategy->title}}">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <div class="row vertical-gap">
                     <div class="col-lg-3 col-md-5">
                         <a href="blog-article.html" class="nk-post-img">
                             <img src="{{ asset('/assets/images/'.$strategy->image) }}" alt="{{$strategy->title}}">
                             <span class="nk-post-categories">
                                 <span class="bg-main-3">{{$strategy->category}}</span>
                             </span>
                         </a>
         ...
         <div role="tabpanel" class="tab-pane fade" id="tabs-1-4">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <a href="blog-article.html" class="nk-post-img">
                     <img src="{{ asset('/assets/images/'.$adventure->image_banner) }}" alt="{{$adventure->title}}">
                     <span class="nk-post-categories">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <div class="row vertical-gap">
                     <div class="col-lg-3 col-md-5">
                         <a href="blog-article.html" class="nk-post-img">
                             <img src="{{ asset('/assets/images/'.$adventure->image) }}" alt="{{$adventure->title}}">
                             <span class="nk-post-categories">
                                 <span class="bg-main-2">{{$adventure->category}}</span>
                             </span>
                         </a>
         ...
         <div role="tabpanel" class="tab-pane fade" id="tabs-1-5">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <a href="blog-article.html" class="nk-post-img">
                     <img src="{{ asset('/assets/images/'.$racing->image_banner) }}" alt="{{$racing->title}}">
                     <span class="nk-post-categories">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <div class="row vertical-gap">
                     <div class="col-lg-3 col-md-5">
                         <a href="blog-article.html" class="nk-post-img">
                             <img src="{{ asset('/assets/images/'.$racing->image) }}" alt="{{$racing->title}}">
                             <span class="nk-post-categories">
         ...
         <div role="tabpanel" class="tab-pane fade" id="tabs-1-6">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <a href="blog-article.html" class="nk-post-img">
                     <img src="{{ asset('/assets/images/'.$indie->image_banner) }}" alt="{{$indie->title}}">
                     <span class="nk-post-categories">
             ...
             <div class="nk-blog-post nk-blog-post-border-bottom">
                 <div class="row vertical-gap">
                     <div class="col-lg-3 col-md-5">
                         <a href="blog-article.html" class="nk-post-img">
                             <img src="{{ asset('/assets/images/'.$indie->image) }}" alt="{{$indie->title}}">
                             <span class="nk-post-categories">
                                 <span class="bg-main-2">{{$indie->category}}</span>
                             </span>
                         </a>
