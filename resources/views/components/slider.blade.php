  <!-- START: Image Slider -->
  <div class="background-video" data-autoplay="8000" style="position: relative;">
      <style>
          .nk-background-video {
              width: 100%;
          }
      ...
      <video class="nk-background-video" src="{{asset('/videos/Retake-hero-desktop.mp4')}}" muted loop autoplay>
      </video>
      ...
      <div class="nk-image-slider-item">
          <img src="{{ asset('/images/'.$slider->image) }}" alt="" class="nk-image-slider-img" data-thumb="{{ asset('/images/'.$slider->image_thumb) }}">
