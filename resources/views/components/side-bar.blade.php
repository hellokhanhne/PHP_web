                ...
                <div class="nk-widget-content">
                    ...
                    <div class="nk-widget-post">
                        <a href="{{URL::to('/blog')}}/{{$recent->id}}" class="nk-post-image">
                            <img src="{{ asset('/assets/images/'.$recent->image) }}" alt="">
                        </a>
                        ...
                        <div class="row sm-gap vertical-gap">
                            ...
                            <div class="col-sm-6">
                                <div class="nk-gallery-item-box">
                                    <a href="{{ asset('/images/'.$screenshot->image) }}" class="nk-gallery-item" data-size="472x438">
                                        <div class="nk-gallery-item-overlay"><span class="ion-eye"></span></div>
                                        <img src="{{ asset('/images/'.$screenshot->image_thumb) }}" alt="">
                                    </a>
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="nk-widget-content">
                    ...
                    <div class="nk-widget-post">
                        <a href="{{URL::to('/product/'.$Product->id)}}" class="nk-post-image">
                            <img src="{{ asset('/images/'.$Product->image0) }}" alt="However, I have reason">
                        </a>
