...
<head>
    ...
    <script defer src="{{URL::asset('/assets/vendor/fontawesome-free/js/v4-shims.js')}}"></script>

    <!-- IonIcons -->
    <link rel="stylesheet" href="{{URL::asset('/assets/vendor/ionicons/css/ionicons.min.css')}}">

    <!-- Flickity -->
    <link rel="stylesheet" href="{{URL::asset('/assets/vendor/flickity/dist/flickity.min.css')}}">

    <!-- Photoswipe -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/assets/vendor/photoswipe/dist/photoswipe.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/assets/vendor/photoswipe/dist/default-skin/default-skin.css')}}">

    <!-- Seiyria Bootstrap Slider -->
    <link rel="stylesheet" href="{{URL::asset('/assets/vendor/bootstrap-slider/dist/css/bootstrap-slider.min.css')}}">

    <!-- Summernote -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/assets/vendor/summernote/dist/summernote-bs4.css')}}">

    <link rel="stylesheet" href="https://unpkg.com/swiper@7/swiper-bundle.min.css" />

    <!-- GoodGames -->
    <link rel="stylesheet" href="{{URL::asset('/assets/css/goodgames.css')}}">
    ...
    <style>
        body{
            background-image: url("{{asset('/images/background-sprite.png')}}");
        }
        #header-user-option {
            position: relative;
            cursor: pointer;
            ...
            <div class="container">
                <div class="nk-nav-table">
                    ...
                    <a href="{{URL::to('/')}}" class="nk-nav-logo">
                        <img src="{{asset('/assets/images/favicon.png')}}" alt="GoodGames" >
                    </a>
